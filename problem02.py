...
"""
def publicBusFare(people):
    errorMessage = "Please Provide a Valid Number as Input"
    if(type(people) == int and people>=0):
        ticketPrice = 250
        peopleInMicroBus = people % 50
        peopleInPublicBus = peopleInMicroBus % 11
        ticketPriceOfPublicBus = peopleInPublicBus * ticketPrice;
        return ticketPriceOfPublicBus
    else:
        return errorMessage

person = publicBusFare("io")
print(person)